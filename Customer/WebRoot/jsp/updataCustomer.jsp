...
<html>
  ...
  <body>
  	<form action="${pageContext.request.contextPath}/servlet/updateCustomer"  id="form" method="post" onsubmit="return makepre()" accept-charset="utf-8" >
